...
class Sampler:
    def __init__(self, voc_path, output_size, context_length):
        self.voc = Vocabulary()
    ...
    def predict_greedy(self, model, input_img, require_sparse_label=True,
                       sequence_length=150, verbose=False, prediction_as_list=False):
